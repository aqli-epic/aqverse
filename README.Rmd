...
of this package will have all functionality in-built in our underlying satellite data processing pipeline and this will serve as
...
Once installed, load the package into your R environment as follows `library(aqverse)`
